---
id: doc-teco-ops-docs-p04
title: "Teco-Ops 项目文档集 — 第p04部分 (README_OP.md)"
type: source-doc-part
parent_doc: doc-teco-ops-docs
product_version: "commit d90ddf5"
source_file: "doc/README_OP.md"
raw_text: "sources/docs/raw-teco-ops/README_OP.txt"
raw_line_range: "1-595"
architectures: [sdaa, teco-t1]
confidence: verified
tags: [teco-ops, operator-development, ual, interface, spm, proto, kernel, dispatch]
---

# Teco-Ops 项目文档集（第p04部分：算子开发指南）
...
- SDAA C 零基础入门：面向零基础学习者的入门教程。
- SDAA C 编程指南：介绍 SDAA C 编程语言、语言规范、函数接口、数学函数、程序编译、程序调试及性能调优等内容。
- 性能优化手册-SDAAC 篇：介绍程序并行、函数接口、数学函数、程序编译过程中的性能优化内容。
- 性能优化手册-算子篇：介绍经典的计算与访存优化办法，包括向量指令、指令流水线、矩阵乘法加速单元、双缓冲、广播优化等。
...
详见算子提交规范中的代码风格章节（`doc-teco-ops-docs-p01`）。

> **注意：** 建议同时创建对应算子的设计文档，参考算子设计文档模板（`doc-teco-ops-docs-p08`）和已有算子文档（如 flatten_rays 设计文档 `doc-teco-ops-docs-p09`）进行编写。
...
- 常见问题（`doc-teco-ops-docs-p02`）— 算子 proto 参数设置及测试框架详细说明
