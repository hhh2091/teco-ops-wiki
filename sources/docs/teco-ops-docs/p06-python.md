---
id: doc-teco-ops-docs-p06
title: "Teco-Ops 项目文档集 — 第p06部分 (README_PYTHON.md)"
type: source-doc-part
parent_doc: doc-teco-ops-docs
product_version: "commit d90ddf5"
source_file: "doc/README_PYTHON.md"
raw_text: "sources/docs/raw-teco-ops/README_PYTHON.txt"
raw_line_range: "1-202"
architectures: [sdaa, teco-t1]
confidence: verified
tags: [teco-ops, pytorch, python-binding, torch-ext, setup-py]
---

# Teco-Ops 项目文档集（第p06部分：PyTorch 扩展绑定）
