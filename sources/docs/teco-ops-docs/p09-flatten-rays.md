---
id: doc-teco-ops-docs-p09
title: "Teco-Ops 项目文档集 — 第p09部分 (op_docs/flatten_rays.md)"
type: source-doc-part
parent_doc: doc-teco-ops-docs
product_version: "commit d90ddf5"
source_file: "doc/op_docs/flatten_rays.md"
raw_text: "sources/docs/raw-teco-ops/op_docs/flatten_rays.txt"
raw_line_range: "1-131"
architectures: [sdaa, teco-t1]
confidence: verified
tags: [teco-ops, op-docs, flatten-rays, worked-example, tiling]
---

# Teco-Ops 项目文档集（第p09部分：flatten_rays 设计文档示例）

# tecoopsFlattenRays 设计文档

> 原文包含两张示意图（`doc/op_docs/pics/flatten_rays.png`、`flatten_tilling.png`），本知识库未收录图片，仅保留文字与公式说明。
