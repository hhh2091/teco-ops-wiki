---
id: doc-teco-ops-docs-p01
title: "Teco-Ops 项目文档集 — 第p01部分 (PR.md)"
type: source-doc-part
parent_doc: doc-teco-ops-docs
product_version: "commit d90ddf5"
source_file: "doc/PR.md"
raw_text: "sources/docs/raw-teco-ops/PR.txt"
raw_line_range: "1-79"
architectures: [sdaa, teco-t1]
confidence: verified
tags: [teco-ops, pr, commit-convention, code-style, cpplint]
---

# Teco-Ops 项目文档集（第p01部分：算子提交规范）
