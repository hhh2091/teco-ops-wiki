---
id: doc-teco-al-docs-p15
title: "Teco-AL 项目文档集 — 第p15部分 (doc/op_docs/scale_tensor.md)"
type: source-doc-part
parent_doc: doc-teco-al-docs
product_version: "v1.0.0 / commit 17c5cd6"
source_file: "doc/op_docs/scale_tensor.md"
raw_text: "sources/docs/raw-teco-al/op_docs/scale_tensor.txt"
raw_line_range: "1-58"
architectures: [sdaa, teco-t1]
confidence: verified
tags: [teco-al, scale-tensor, elementwise]
---

# Teco-AL 项目文档集（第p15部分：ScaleTensor 设计文档）

# tecoalScaleTensor设计文档

## 计算原理

根据给定因子alpha，对张量元素y进行缩放。
...
```c++
tecoalStatus_t TECOALWINAPI tecoalScaleTensor(
...
|算法取值|计算分支|含义说明|
|---|---|---|
|`TECOAL_ALGO_0`|tecoKernelScaleTensorFT32|基础实现。|
...
|参数|数据类型|维度信息|存储格式|
|---|---|---|---|
| yDesc | float32 | Tensor4D | NHWC和NCHW |
