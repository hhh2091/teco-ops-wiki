---
id: doc-teco-al-docs-p02
title: "Teco-AL 项目文档集 — 第p02部分 (doc/tutorial/dev_guide.md)"
type: source-doc-part
parent_doc: doc-teco-al-docs
product_version: "v1.0.0 / commit 17c5cd6"
source_file: "doc/tutorial/dev_guide.md"
raw_text: "sources/docs/raw-teco-al/tutorial/dev_guide.txt"
raw_line_range: "1-167"
architectures: [sdaa, teco-t1]
confidence: verified
tags: [teco-al, dev-guide, handle, tensor, descriptor, workspace, interface, ual]
---

# Teco-AL 项目文档集（第p02部分：开发指南）

> 原文包含两张示意图（`doc/tutorial/pics/concept_tensor.png`、`concept_layout.png`），本知识库未收录图片，仅保留文字说明。

## 概述

本文主要阐明用户在Teco-AL仓库开发算子时，可以参考的信息。
...
基于Teco-AL的整体目录结构（详见`doc-teco-al-docs-p01`），用户熟悉或开发各个算子代码均需要着重关注以下部分（本节统一使用tecoalAddTensor代码做示例介绍）。
