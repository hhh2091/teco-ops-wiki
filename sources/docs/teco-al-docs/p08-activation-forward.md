---
id: doc-teco-al-docs-p08
title: "Teco-AL 项目文档集 — 第p08部分 (doc/op_docs/activation_forward.md)"
type: source-doc-part
parent_doc: doc-teco-al-docs
product_version: "v1.0.0 / commit 17c5cd6"
source_file: "doc/op_docs/activation_forward.md"
raw_text: "sources/docs/raw-teco-al/op_docs/activation_forward.txt"
raw_line_range: "1-70"
architectures: [sdaa, teco-t1]
confidence: verified
tags: [teco-al, activation-forward, silu]
---

# Teco-AL 项目文档集（第p08部分：ActivationForward 设计文档）

# tecoalActivationForward设计文档
...
|算法取值|计算分支|含义说明|
|---|---|---|
|`TECOAL_ALGO_0`|tecoKernelActivationForwardFT16|基础实现。|
