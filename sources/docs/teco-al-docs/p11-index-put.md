---
id: doc-teco-al-docs-p11
title: "Teco-AL 项目文档集 — 第p11部分 (doc/op_docs/index_put.md)"
type: source-doc-part
parent_doc: doc-teco-al-docs
product_version: "v1.0.0 / commit 17c5cd6"
source_file: "doc/op_docs/index_put.md"
raw_text: "sources/docs/raw-teco-al/op_docs/index_put.txt"
raw_line_range: "1-99"
architectures: [sdaa, teco-t1]
confidence: verified
tags: [teco-al, index-put, scatter, indexing]
---

# Teco-AL 项目文档集（第p11部分：IndexPut 设计文档）
...
| indicesDesc    | 输入      | 主机端        | 索引张量的描述符构成的数组。详见《开发指南——核心概念——描述符》（`doc-teco-al-docs-p02`）章节的介绍。                          |
| indices        | 输入      | 设备端        | 指向indicesDesc的数据指针构成的指针数组。                                            |
| valuesDesc     | 输入      | 主机端        | 数据values的描述符。详见《开发指南——核心概念——描述符》（`doc-teco-al-docs-p02`）章节的介绍。                                  |
| values         | 输入      | 设备端        | 需要更新的结果数据。                                                                 |
| inputDesc      | 输入      | 主机端        | 数据input的描述符。预留参数，实际无操作。详见《开发指南——核心概念——描述符》（`doc-teco-al-docs-p02`）章节的介绍。             |
